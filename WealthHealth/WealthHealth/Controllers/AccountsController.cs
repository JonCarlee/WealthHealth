...
namespace WealthHealth.Controllers
{
    public class AccountsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Amount,HouseholdId")] Account account)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Amount,HouseholdId")] Account account)
        {
            if (ModelState.IsValid)
            {
